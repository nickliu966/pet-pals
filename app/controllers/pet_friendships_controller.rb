  ...
  def update
    ...
    respond_to do |format|
      if @pet_friendship.update(pet_friendship_params)
        format.html do
          redirect_back fallback_location: pet_friendships_path,
                        notice: "Pet friendship was successfully updated."
        end
        ...
        format.html do
          redirect_back fallback_location: pet_friendships_path,
                        alert: @pet_friendship.errors.full_messages.to_sentence
        end
